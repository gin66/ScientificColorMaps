...
func getContrast(_ col1: simd_float3, _ col2: simd_float3) -> Float {
  let color1 = NSColor(
    cgColor: CGColor(red: CGFloat(col1.x), green: CGFloat(col1.y), blue: CGFloat(col1.z), alpha: 1))!
  let color2 = NSColor(
    cgColor: CGColor(red: CGFloat(col2.x), green: CGFloat(col2.y), blue: CGFloat(col2.z), alpha: 1))!
