...
public final class ScientificColor: Sendable, Equatable, Hashable, Codable {
    ...
    public static func == (lhs: ScientificColor, rhs: ScientificColor) -> Bool {
        lhs.red == rhs.red && lhs.green == rhs.green && lhs.blue == rhs.blue && lhs.maxValueOfMap == rhs.maxValueOfMap
    }
    ...
    init(_ index: Int, _ categoryIndex: Int? = nil, _ red: Float, _ green: Float, _ blue: Float, maxValueOfMap: Float) {
        self.index = index
    ...
    public func maximized() -> ScientificColor {
        ScientificColor(index, categoryIndex, red/maxValueOfMap, green/maxValueOfMap, blue/maxValueOfMap, maxValueOfMap: 1)
    }
