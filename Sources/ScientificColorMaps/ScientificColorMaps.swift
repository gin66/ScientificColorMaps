...
public final class ScientificColorMaps: Sendable, Hashable, Identifiable {
    ...
    // Maximum value of all colors' components in the range 0 to 1.
    ...
    public func discrete50() -> [ScientificColor] {
        ...
        [
            ...
            220, 225, 230, 235, 240, 246, 251, 256,
        ].map {
            rgb_data[$0 - 1]
        }
    }
    ...
    public func mapToColor(value: Float, minValue: Float = 0, maxValue: Float = 1)
        -> ScientificColor
    {
